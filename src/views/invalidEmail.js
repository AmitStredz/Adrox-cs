...
function InvalidEmail({ closeModal }) {
  ...
  return (
    <div ref={modalRef} onClick={bgModal}
      ...
      data-aos="zoom-in"
    >
      <div className="flex flex-col items-center gap-2 bg-gradient-to-r from-[#34104A] to-[#250939] p-10 rounded-3xl">
        ...
        <p className="text-center text-[14px] sm:text-[18px]">Enter a Valid Email id.</p>
      </div>
    </div>
  );
}
